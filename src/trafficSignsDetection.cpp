...
array_traffic detectObjects(Mat in){
    ...
    //inRange(hsv_imag.clone(), Scalar(170, 160, 05), Scalar(179, 255, 255), upper_hue_range);      // Segmentation of upper range of red
    ...
    //inRange(hsv_imag.clone(), Scalar(13, 180, 10), Scalar(27, 255, 255), image_y);
    //erode( image_y.clone(), image_y, element );
    ////inRange(hsv_imag.clone(), Scalar(101, 50, 20), Scalar(128, 255, 255), image_b);
    //inRange(hsv_imag.clone(), Scalar(85, 50, 05), Scalar(128, 255, 255), image_b);
    
    inRange(hsv_imag.clone(), Scalar(0, 40, 50), Scalar(10, 255, 255), lower_hue_range);         // segmentation of lower range of red
    inRange(hsv_imag.clone(), Scalar(100, 040, 05), Scalar(190, 255, 255), upper_hue_range);      // Segmentation of upper range of red
    addWeighted(lower_hue_range, 1.0, upper_hue_range, 1.0, 0.0, image_r);            // Adding the two ranges
    //inRange(hsv_imag.clone(), Scalar(13, 100, 20), Scalar(25, 255, 255), image_y);
    inRange(hsv_imag.clone(), Scalar(00, 180, 150), Scalar(27, 255, 255), image_y);
    erode( image_y.clone(), image_y, element );
    inRange(hsv_imag.clone(), Scalar(60, 50, 20), Scalar(128, 255, 255), image_b);

    //inRange(hsv_imag.clone(), Scalar(60, 50, 01), Scalar(150, 255, 255), image_b);
